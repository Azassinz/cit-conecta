...
module.exports = [
  ...
  ['meta', { name: 'mobile-web-app-title', content: `CIT Conecta` }],
  ['meta', { name: 'theme-color', content: `#263647` }],
  ['meta', { name: 'msapplication-navbutton-color', content: `#263647` }],
  ...
  // Microsoft
  ['meta', { name: 'application-name', content: `CIT Conecta` }],
  ['meta', { name: 'msapplication-TileColor', content: `#263647` }],
  ['meta', { name: 'msapplication-config', content: '/browserconfig.xml' }],
  ['meta', { name: 'msapplication-square150x150logo', content: '/favicon/android-chrome-192x192.png' }],
  ['meta', { name: 'msapplication-wide310x150logo', content: '/favicon/android-chrome-512x512.png' }],
  ...
  ['link', { rel: 'alternate', href: `https://blog.cit-its.org`, hreflang: 'en' }],
  ['link', { rel: 'alternate', href: `https://blog.cit-its.org/es/`, hreflang: 'es' }],
